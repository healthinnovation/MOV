...
df4<-df3 %>% 
  ...
  geom_sf(alpha = 0.9, aes(fill=sii), size = 0.2) +
...
plot_grid(g1,g2,g3,g4,legend, ncol = 1, labels = c("A","B","C","D"), rel_heights = c(.8,.8,.2))
...
ggplot(aes(x = ANIO, y = ssi, group = JUNTOS)) +
  ...
  #geom_ribbon(aes(ymin = sii_l, ymax = sii_h, fill = JUNTOS), alpha = 0.1)+
  geom_hline(aes(yintercept = 0), linetype = "dashed") + 
...
ggplot(aes(x = ANIO, y = ssi, group = TIPORESIDENCIA)) +
  ...
  #geom_ribbon(aes(ymin = sii_l, ymax = sii_h, fill = TIPORESIDENCIA), alpha = 0.1)+
  geom_hline(aes(yintercept = 0), linetype = "dashed") + 
...
tipocred<-
  ...
  #geom_ribbon(aes(ymin = sii_l, ymax = sii_h, fill = tiposeguro), alpha = 0.1)+
  geom_hline(aes(yintercept = 0), linetype = "dashed") + 
...
ggsave("panel_sii.png",height = 12, width = 17)
