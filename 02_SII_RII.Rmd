...
table(MOV_GENERAL$V190,MOV_GENERAL$INDICERIQUEZA, exclude = NULL)
...
ggsave("Fig4.png", width =11, height = 15)
```
...
ggplot(aes(x = ANIO, y = ssi, group = JUNTOS)) +
 ...
 geom_errorbar(aes(ymin = sii_l, ymax = sii_h, color=JUNTOS), width = 0.2, size = 0.7)+
  ...
  facet_grid(JUNTOS+estrato~vacunatipo, scales="free")
```
...
ggplot(aes(x = ANIO, y = ssi, group = TIPORESIDENCIA)) +
 ...
 geom_errorbar(aes(ymin = sii_l, ymax = sii_h, color=TIPORESIDENCIA), width = 0.2, size = 0.7)+
  ...
  facet_grid(TIPORESIDENCIA+estrato~vacunatipo, scales="free")
```
...
tipocred<-
 ...
 geom_errorbar(aes(ymin = sii_l, ymax = sii_h, color=tiposeguro), width = 0.2, size = 0.7)+
  ...
  facet_grid(tiposeguro+estrato~vacunatipo, scales="free")
...
ggsave("panel_sii.png",height = 20, width = 17)
