...
rota1<-  
 ...
 rbind(ptv1,neumo1,influ1,rota1) %>% 
  ...
  scale_fill_manual(values = c("#595260","#7ECA9C","#A799B7","#AD6C80"),
...
ggsave("figura2.png", height = 9, width = 8.5)
```
