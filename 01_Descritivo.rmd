...
t<-MOV_GENERAL %>% 
  select(ANIO,S45PV1_1,S45PV2_1,S45PV3_1) %>% 
  mutate(vacuna  = ifelse(S45PV1_1 == 1 & S45PV2_1 == 1 & S45PV3_1 ==1, list(c("PTV1","PTV2","PTV3")),
                          ifelse(S45PV1_1 == 0 & S45PV2_1 == 0 & S45PV3_1 ==0, list(c(NA)),
                                 ifelse(S45PV1_1 == 1 & S45PV2_1 == 0 & S45PV3_1 ==0, list(c("PTV1")),
                                        ifelse(S45PV1_1 == 1 & S45PV2_1 == 1 & S45PV3_1 ==0, list(c("PTV1","PTV2")),NA)))) 
...
df2<-MOV_GENERAL %>%
  ...
  mutate(vacuna1  = ifelse(S45PV1_1 == 1 & S45PV2_1 == 1 & S45PV3_1 ==1, list(c("PTV1","PTV2","PTV3")),
                          ifelse(S45PV1_1 == 0 & S45PV2_1 == 0 & S45PV3_1 ==0, list(c(NA)),
                                 ifelse(S45PV1_1 == 1 & S45PV2_1 == 0 & S45PV3_1 ==0, list(c("PTV1")),
                                        ifelse(S45PV1_1 == 1 & S45PV2_1 == 1 & S45PV3_1 ==0, list(c("PTV1","PTV2")),NA)))),
         
         
         vacuna2  = ifelse(S45NM1_1 == 1 & S45NM2_1 == 1 & S45NM3_1 ==1, list(c("NEUMO1","NEUMO2","NEUMO3")),
                          ifelse(S45NM1_1 == 0 & S45NM2_1 == 0 & S45NM3_1 ==0, list(c(NA)),
                                 ifelse(S45NM1_1 == 1 & S45NM2_1 == 0 & S45NM3_1 ==0, list(c("NEUMO1")),
                                        ifelse(S45NM1_1 == 1 & S45NM2_1 == 1 & S45NM3_1 ==0, list(c("NEUMO1","NEUMO2")),NA)))),
         
         
         
         vacuna3 = ifelse(S45IF1_1 == 1 & S45IF2_1 == 1, list(c("INFLU1","INFLU2")),
                         ifelse(S45IF1_1 == 0 & S45IF2_1 == 0, list(c(NA)),
                                ifelse(S45IF1_1 == 1 & S45IF2_1 == 0, list(c("INFLU1")),NA))),
         
         
         
         vacuna4 = ifelse(S45RT1_1 == 1 & S45RT1_1 == 1, list(c("ROTA1","ROTA2")),
                         ifelse(S45RT1_1 == 0 & S45RT1_1 == 0, list(c(NA)),
                                ifelse(S45RT1_1 == 1 & S45RT1_1 == 0, list(c("ROTA1")),NA))),
         
         
         
         vacuna5 = ifelse(S45PV1_1==1 & S45RT1_1 == 1 & S45IF1_1==1 & S45NM1_1 == 1, list(c("PTV1","ROTA1","INFLU1","NEUMO1")),
                          ifelse(S45PV1_1==0 & S45RT1_1 == 0 & S45IF1_1==0 & S45NM1_1 == 0, list(c(NA)),
                                 ifelse(S45PV1_1==1 & S45RT1_1 == 1 & S45IF1_1==1 & S45NM1_1 == 0, list(c("PTV1","ROTA1","INFLU1")),
                                        ifelse(S45PV1_1==0 & S45RT1_1 == 1 & S45IF1_1==1 & S45NM1_1 == 1, list(c("ROTA1","INFLU1","NEUMO1")),
                                               ifelse(S45PV1_1==1 & S45RT1_1 == 0 & S45IF1_1==1 & S45NM1_1 == 1, list(c("PTV1","INFLU1","NEUMO1")),
                                                      ifelse(S45PV1_1==1 & S45RT1_1 == 1 & S45IF1_1==0 & S45NM1_1 == 1, list(c("PTV1","ROTA1","INFLU1")),
                                                             ifelse(S45PV1_1==1 & S45RT1_1 == 1 & S45IF1_1==0 & S45NM1_1 == 0,list(c("PTV1","ROTA1")),
                                                                    ifelse(S45PV1_1==0 & S45RT1_1 == 0 & S45IF1_1==1 & S45NM1_1 == 1,list(c("INFLU1","NEUMO1")),
                                                                           ifelse(S45PV1_1==1 & S45RT1_1 == 0 & S45IF1_1==0 & S45NM1_1 == 1,list(c("PTV1","NEUMO1")),
                                                                                  ifelse(S45PV1_1==0 & S45RT1_1 == 1 & S45IF1_1==0 & S45NM1_1 == 1,list(c("ROTA1","NEUMO1")),
                                                                                         ifelse(S45PV1_1==1 & S45RT1_1 == 0 & S45IF1_1==1 & S45NM1_1 == 0,list(c("PTV1","INFLU1")),
                                                                                                ifelse(S45PV1_1==0 & S45RT1_1 == 1 & S45IF1_1==1 & S45NM1_1 == 0,list(c("ROTA1","INFLU1")),
                                                                                                       ifelse(S45PV1_1==1 & S45RT1_1 == 0 & S45IF1_1==0 & S45NM1_1 == 0,list(c("PTV1")),
                                                                                                              ifelse(S45PV1_1==0 & S45RT1_1 == 1 & S45IF1_1==0 & S45NM1_1 == 0,list(c("ROTA1")),
                                                                                                                     ifelse(S45PV1_1==0 & S45RT1_1 == 0 & S45IF1_1==1 & S45NM1_1 == 0,list(c("INFLU1")),
                                                                                                                ifelse(S45PV1_1==0 & S45RT1_1 == 0 & S45IF1_1==0 & S45NM1_1 == 1,list(c("NEUMO1")),NA)))))))))))))))),
