...
# Datos listos
MOV2020_2<- prep.data(MOV2020)

write.csv(MOV2020_2,"./BD.INTERMEDIAS/MOV2020_2.csv",row.names = F)
...
PTV<-svyby(~MOV_PTV_e1_2, by=~DEPARTAMEN, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
NEUMO<-svyby(~MOV_NEUMO_e1_2, by=~DEPARTAMEN, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
INFLU<-svyby(~MOV_INFLU_e1_2, by=~DEPARTAMEN, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
ROTA<-svyby(~MOV_ROTA_e1, by=~DEPARTAMEN, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
```{r, echo=F, warning=F, message=F, error=F}
PTV<-svyby(~MOV_PTV_e1_2, by=~CRED, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
NEUMO<-svyby(~MOV_NEUMO_e1_2, by=~CRED, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
INFLU<-svyby(~MOV_INFLU_e1_2, by=~CRED, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
ROTA<-svyby(~MOV_ROTA_e1, by=~CRED, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
```{r, echo=F, warning=F, message=F, error=F}
PTV<-svyby(~MOV_PTV_e1_2, by=~CREDLUGAR, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
NEUMO<-svyby(~MOV_NEUMO_e1_2, by=~CREDLUGAR, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
INFLU<-svyby(~MOV_INFLU_e1_2, by=~CREDLUGAR, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
ROTA<-svyby(~MOV_ROTA_e1, by=~CREDLUGAR, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
```{r, echo=F, warning=F, message=F, error=F}
PTV<-svyby(~MOV_PTV_e1_2, by=~TIPORESIDENCIA + DEPARTAMEN, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
NEUMO<-svyby(~MOV_NEUMO_e1_2, by=~TIPORESIDENCIA +DEPARTAMEN, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
INFLU<-svyby(~MOV_INFLU_e1_2, by=~TIPORESIDENCIA +DEPARTAMEN, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
ROTA<-svyby(~MOV_ROTA_e1, by=~TIPORESIDENCIA +DEPARTAMEN, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
...
NEUMO2<-svyby(~S45NM1_1, by=~DEPARTAMEN+EDAD_CAT_V, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
  
  mutate(vacuna = S45NM1_1,vacunatipo = "NEUMO_2") %>% 
  
  select(-`se.as.numeric(S45NM1_1)`,-S45NM1_1)

NEUMO3<-svyby(~S45NM1_1, by=~DEPARTAMEN+EDAD_CAT_V, design =df, FUN=svyciprop, vartype=c('se','ci')) %>% 
  
  mutate(vacuna = S45NM1_1,vacunatipo = "NEUMO_3") %>% 
